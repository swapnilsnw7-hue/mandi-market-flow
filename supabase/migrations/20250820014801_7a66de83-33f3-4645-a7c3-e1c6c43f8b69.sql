-- Enable RLS on spatial_ref_sys table (created by PostGIS extension)
-- This is safe as it's a reference table for spatial data
ALTER TABLE public.spatial_ref_sys ENABLE ROW LEVEL SECURITY;

-- Create policy for spatial_ref_sys (read-only reference data)
